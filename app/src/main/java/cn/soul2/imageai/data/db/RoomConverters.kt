...
class RoomConverters {
    ...
    @TypeConverter
    fun imagePartitionToStorage(value: ImagePartition): String = value.name

    @TypeConverter
    fun imagePartitionFromStorage(value: String): ImagePartition = ImagePartition.valueOf(value)
